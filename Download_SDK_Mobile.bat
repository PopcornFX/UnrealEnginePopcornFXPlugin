...
bitsadmin /addfile third_party_download_mobile https://downloads.popcornfx.com/Plugins/UE4/UnrealEngine_PopcornFXPlugin_2.22.6_iOS_Android.7z "%~dp0\_PopcornFX_Runtime_SDK_Mobile.7z"
