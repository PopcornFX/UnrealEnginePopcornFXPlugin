...
class	CBatchDrawer_Triangle_CPUBB : public PopcornFX::CRendererBatchJobs_Triangle_CPUBB
{
	typedef PopcornFX::CRendererBatchJobs_Triangle_CPUBB	Super;
private:
...
private:
	void		_IssueDrawCall_Triangle(const SUERenderContext &renderContext, const PopcornFX::SDrawCallDesc &desc);
