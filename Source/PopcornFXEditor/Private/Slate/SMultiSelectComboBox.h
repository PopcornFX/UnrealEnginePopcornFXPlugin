...
/**
 * Copy of Wdigets/Input/SComboBox.h but does not close when selecting an item
 * TODO: handle row creation here and allow selecting values with space
 */
template< typename OptionType >
class SMultiSelectComboBox : public SComboButton
{
public:
	...
	void Construct( const FArguments& InArgs )
	{
		...
		ComboBoxMenuContent =
			...
			[
				...
				.OnGenerateRow(this, &SMultiSelectComboBox< OptionType >::GenerateMenuItemRow)
				//.OnSelectionChanged(this, &SMultiSelectComboBox< OptionType >::OnSelectionChanged_Internal)
				.OnKeyDownHandler(this, &SMultiSelectComboBox< OptionType >::OnKeyDownHandler)
		...
		if (InArgs._Content.Widget == SNullWidget::NullWidget)
		{
			...
			.Text(NSLOCTEXT("SMultiSelectComboBox", "ContentWarning", "No Content Provided"))
		...
		SComboButton::Construct( SComboButton::FArguments()
			...
			.OnMenuOpenChanged(this, &SMultiSelectComboBox< OptionType >::OnMenuOpenChanged)
		...
		/**
		* An accessible implementation of SMultiSelectComboBox to expose to platform accessibility APIs.
		...
		* For subclasses of SMultiSelectComboBox, inherit and override the necessary functions
		*/
		...
		public:
			...
			virtual FString GetValue() const override
			{
				if (Widget.IsValid())
				{
					TSharedPtr<SMultiSelectComboBox<OptionType>> ComboBox = StaticCastSharedPtr<SMultiSelectComboBox<OptionType>>(Widget.Pin());
		...
		{
			return MakeShareable<FSlateAccessibleWidget>(new SMultiSelectComboBox<OptionType>::FSlateAccessibleComboBox(SharedThis(this)));
		}
